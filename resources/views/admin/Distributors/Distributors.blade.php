                    ...
                    <div class="table-responsive">
                        <table id="zero_config" class="table table-striped table-bordered" style="table-layout: fixed;width: available">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><img width="64" height="64" src="{{asset($Distributor->image)}}" alt="{{$Distributor->name}}"></td>
                                    <td>{{$Distributor->name}}</td>
                                    <td>{{$Distributor->phone}}</td>
                                    <td>{{$Distributor->description}}</td>
                                    <td>{{$Distributor->address}}</td>
                                    <td><div class="row"> <a href="/admin/Distributors/Edit/{{$Distributor->id}}" id="edit_popup" class="button button-rounded button-reveal button-small button-teal edit_popup"><i class="fa fa-edit"></i><span>Edit</span></a>
                                            <a href="/admin/Distributors/Delete/{{$Distributor->id}}" id="edit_sub" class="button button-rounded button-reveal button-small button-teal edit_sub"><i class="fa fa-trash"></i><span>Delete</span></a></div></td>
