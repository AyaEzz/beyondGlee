        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Edit Coupon : {{$coupon->code}}</h4>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form id="example-form" action="{{route('admin.Coupons.Edit', ['id' => $coupon->id])}}" method="post" class="m-t-40" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                        ...
                                        <input type="text" name="Coupon" id="Coupon" class="col-sm-3 text-right sm-form-control" placeholder="{{$coupon->code}}" value="{{$coupon->code}}" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="amount" name="amount" placeholder="{{$coupon->amount}}" value="{{$coupon->amount}}" required>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="maxuse" name="maxuse" placeholder="{{$coupon->max_use_times}}" value="{{$coupon->max_use_times}}" required>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="datetime" class="form-control" id="starttime" name="starttime" placeholder="{{$coupon->start_time}}" value="{{$coupon->start_time}}" required>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="datetime" class="form-control" id="endtime" name="endtime" placeholder="{{$coupon->end_time}}" value="{{$coupon->end_time}}" required>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @if(!$coupon->fisubcategory)


                                    Applied On All Categories
