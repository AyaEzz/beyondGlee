                    ...
                    <div class="table-responsive">
                        <table id="zero_config" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="/admin/Coupons/Edit/{{$coupon->id}}" id="edit_sub" class="button button-rounded button-reveal button-small button-teal edit_sub"><i class="fa fa-edit"></i><span>Edit</span></a></td>
                                    <td>#{{$coupon->id}}</td>
                                    <td>{{$coupon->code}}</td>
                                    <td>@if($coupon->active) <strong>Activated</strong>  @else <a href="/admin/Coupons/Active/{{$coupon->id}}" id="edit_sub" class="button button-rounded button-reveal button-small button-teal edit_sub"><i class="mdi mdi-arrow-up-bold-circle"></i><span>Active</span></a> @endif </td>
                                    <td>{{$coupon->amount}}</td>
