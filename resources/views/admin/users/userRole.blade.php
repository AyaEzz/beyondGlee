                        ...
                        <table id="zero_config" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$user->phone}}</td>
                                    <td>{{$user->roleName}}</td>
                                    <td><a href="/admin/userrole/{{$user->id}}" id="edit_popup" class="button button-rounded button-reveal button-small button-teal edit_popup"><i class="far fa-edit"></i><span>Edit Role</span></a></td>
                                </tr>
                                @endforeach
