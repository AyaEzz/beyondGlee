                        ...
                        <table id="zero_config" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$user->state}}</td>
                                    <td>{{$user->address}}</td>
                                    <td><a href="/admin/editprofile/{{$user->id}}" id="edit_popup" class="button button-rounded button-reveal button-small button-teal edit_popup"><i class="far fa-edit"></i><span>Edit Profile</span></a></td>
                                </tr>
                                @endforeach
