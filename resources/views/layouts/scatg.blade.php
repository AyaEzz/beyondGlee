...
@section('content')
        ...
        <div class="content-wrap">
            ...
            <div class="container clearfix">
                ...
                <ul id="portfolio-filter" class="portfolio-filter divcenter clearfix" data-container="#portfolio">
                    ...
                    <li ><a href="/category/{{$cat}}" data-filter="*">Show All</a></li>
                    @foreach ($catNames as $catName)

                    <li {{($catName == $subcat) ? 'class=activeFilter':''}}><a  href="/category/{{$cat}}/{{$catName}}" data-filter=".pf-{{$catName}}">{{$catName}}</a></li>
                        @endforeach
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.portfolio').isotope({ filter: '.pf-{{$subcat}}' });
